...
const MyPage = ({loginUser,loginInfo,setLoginInfo,setLoginUser}) => {
   ...
   const renderPage = ()=>{
        switch (role) {
            ...
            case 'city':
                return <CityPage loginInfo={loginInfo} loginUser={loginUser} setLoginInfo={setLoginInfo} setLoginUser={setLoginUser}/>
            default:
